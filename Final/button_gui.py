...
class name_buttons(object):
    ...
    def update_display(self, num_players, buttons):
        ...
        trans = pyg.Surface((800, 70))  # starts at (0,0) and builds (width,height)
        trans.set_alpha(245)  # 0 is invisible, 255 is solid, 128 is recommended
        trans.fill((60, 60, 60))
        ...
        if num_players == 3:
            ...
            text = font.render("Click on Player 1, Player 2, Player 3 to enter your names", 1, (255, 255, 255))

        else:
            text = font.render("Click on Player 1, Player 2 to enter your names", 1, (255, 255, 255))
